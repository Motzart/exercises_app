...
const OverviewStats = () => {
  ...
  const formatDurationForDisplay = (duration: string | undefined): { hours: string; minutes: string } => {
    ...
    <div className="flex flex-row gap-4 items-center justify-between">
      <div className="w-full items-center justify-center flex flex-col">
        ...
        <div className="text-[72px] font-light text-white">
            <span className="text-[72px] font-light text-white">{isLoading ? '00' : hours}</span>
            <span className="text-[48px] font-light text-white">,{isLoading ? '00' : minutes}</span>
        </div>
        <span className="text-[12px] font-bold text-white uppercase">Загальний час</span>
      </div>
      <div className="w-full">
        <ul className="grid grid-cols-2 gap-4">
          ...
          <li className="bg-gray-800/50 rounded-lg p-4">
            <span className="text-sm font-light text-white">Минулого тижня</span>
            <span className="text-xl font-bold text-white ml-2">00h:00m</span>
          </li>
          <li className="bg-gray-800/50 rounded-lg p-4">
          ...
          <li className="bg-gray-800/50 rounded-lg p-4">
            <span className="text-sm font-light text-white">Минулого місяця</span>
            <span className="text-xl font-bold text-white ml-2">00h:00m</span>
          </li>
        </ul>
      </div>

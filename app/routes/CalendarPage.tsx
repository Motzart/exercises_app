    ...
    <div className="container mx-auto relative isolate overflow-hidden pt-16">
      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-16">
        <div className="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
          ...
          <div className="mt-6 grid grid-cols-7 text-xs/6 text-gray-400">
            <div>M</div>
            <div>T</div>
            <div>W</div>
            <div>T</div>
        ...
        <ol className="mt-4 divide-y divide-white/10 text-sm/6 lg:col-span-7 xl:col-span-8">
          {meetings.map((meeting) => (
            ...
            >
              ...
              <div className="flex-auto">
                ...
                <dl className="mt-2 flex flex-col text-gray-400 xl:flex-row">
                  ...
                  <div className="mt-2 flex items-start gap-x-3 xl:mt-0 xl:ml-3.5 xl:border-l xl:border-gray-500/50 xl:pl-3.5">
                    <dt className="mt-0.5">
              ...
              >
                <MenuButton className="relative flex items-center rounded-full text-gray-400 hover:text-white">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-gray-800 outline-1 -outline-offset-1 outline-white/10 transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                >
                  <div className="py-1">
                    <MenuItem>
                      <a
